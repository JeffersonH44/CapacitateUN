...
public class UserRegister {
    ...
    /**
     * Crea un nuevo usuario a partir de los nombres, apellidos, nombre de
     * usuario, contraseña y el identificador.
     *
    ...
    /**
     * Realiza el login del usuario a partir de un nombre de usuario y
     * contraseña
     *
     * @param username - Nombre de usuario.
     * @param password - Contraseña.
     ...
     */
    public User loginUser(String username, UserDAO userDAO) {
